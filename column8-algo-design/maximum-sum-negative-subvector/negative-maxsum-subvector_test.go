...
func TestMaxSubVector(t *testing.T) {
	...
	tests := []testData{
		...
		testData{vector: []float64{-2.4, -5.1, -13}, expectedValue: -2.4},
		testData{vector: []float64{-2.4, -1, -13}, expectedValue: -1},
		testData{vector: []float64{2.4, -5.1, 13}, expectedValue: 13},
		testData{vector: []float64{2.4, -1.1, 13}, expectedValue: 14.3},
		testData{vector: []float64{math.Inf(-1), 1.5, -1.0, 13}, expectedValue: 13.5},
		testData{vector: []float64{math.Inf(-1), math.Inf(-5), math.Inf(-10)}, expectedValue: math.Inf(-3)},
		testData{vector: []float64{4, math.Inf(1), 3, 500}, expectedValue: math.Inf(1)},
		testData{vector: []float64{}, expectedValue: math.Inf(-1)},
		testData{vector: nil, expectedValue: math.Inf(-1)},
	}
